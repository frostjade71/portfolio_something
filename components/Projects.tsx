...
function ProjectCard({
    ...
    return (
        <motion.div
            ...
            className="group block bg-card-bg border border-card-border rounded-[1.75rem] overflow-hidden hover:border-[#2a2a2a] transition-all duration-500 flex flex-col h-full"
        >
            {/* Screenshot area */}
            {project.image ? (
                <div className="relative h-[200px] md:h-[240px] overflow-hidden bg-[#0e0e0e] shrink-0">
                    <div
                ...
                <div className="relative h-[200px] md:h-[240px] overflow-hidden bg-[#0e0e0e] flex items-center justify-center shrink-0">
                    <div className="text-text-dim text-6xl font-serif italic">✦</div>
                    <div className="absolute inset-x-0 bottom-0 h-20 bg-gradient-to-t from-card-bg to-transparent" />
                </div>
            )}
            ...
            <div className="px-7 py-6 flex flex-col flex-grow">
                <div className="flex items-center gap-2 mb-3 flex-wrap">
                    {project.tech.map((tech) => (
                        <span 
                            key={tech} 
                            className="text-[9px] uppercase tracking-wider font-bold text-text-dim px-2 py-0.5 bg-white/[0.03] border border-white/[0.05] rounded-md"
                        >
                            {tech}
                        </span>
                    ))}
                </div>
                <h3 className="text-lg font-semibold text-white mb-2 group-hover:text-text-secondary transition-colors">
                    {project.title}
                </h3>
