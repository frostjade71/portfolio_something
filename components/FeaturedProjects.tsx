...
const featuredProjects = [
    ...
    },
    {
        ...
        description: 'Unifying Minecraft players and creators to explore and grow. Find, vote, and explore the best Minecraft servers and realms. Whether you are looking for a new world to join or want to grow your own servers community, Realm Explorer is your central hub for discovery.',
        ...
        <section className="py-16 md:py-24 overflow-hidden">
            ...
            <div className="relative">
                ...
                <div
                    ...
                    className="flex overflow-x-auto no-scrollbar cursor-grab active:cursor-grabbing pt-6 pb-10 w-full select-none"
    ...
    return (
        <div className="w-[260px] md:w-[350px] shrink-0 bg-card-bg border border-card-border rounded-3xl md:rounded-4xl transition-all duration-500 hover:border-white/30 hover:-translate-y-2 hover:shadow-[0_8px_30px_rgb(0,0,0,0.12)] hover:shadow-white/[0.02] group relative overflow-hidden flex flex-col">
            ...
            <div className="relative aspect-[16/9] w-full shrink-0 overflow-hidden bg-[#0e0e0e]">
                ...
                <div className="absolute inset-x-0 bottom-0 h-16 md:h-20 bg-gradient-to-t from-card-bg to-transparent pointer-events-none" />
            </div>
